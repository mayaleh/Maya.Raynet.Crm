...
namespace Maya.Raynet.Crm.Request.Get
{
    public class BulkEmailRecipients : GetRequest
    {
        ...
        public async Task<Model.DataResult<List<Response.BulkEmailRecipients>>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<List<Response.BulkEmailRecipients>>(apiClient);
