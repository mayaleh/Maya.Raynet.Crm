...
namespace Maya.Raynet.Crm.Request.Get
{
    public class PriceLists : GetRequest
    {
        ...
        public async Task<Model.DataResult<List<Response.PriceLists>>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<List<Response.PriceLists>>(apiClient);
