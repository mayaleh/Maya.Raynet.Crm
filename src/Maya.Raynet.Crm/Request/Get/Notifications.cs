...
namespace Maya.Raynet.Crm.Request.Get
{
    public class Notifications : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Notification>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Notification>>(apiClient);
        }
