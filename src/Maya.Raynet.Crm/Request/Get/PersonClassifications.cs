...
namespace Maya.Raynet.Crm.Request.Get
{
    public class PersonClassifications : GetRequest
    {
        ...
        public async Task<Model.DataResult<Response.PersonClassifications>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Response.PersonClassifications>(apiClient);
