...
namespace Maya.Raynet.Crm.Request.Get
{
    public class Projects : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Project>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Project>>(apiClient);
        }
