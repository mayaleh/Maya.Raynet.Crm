...
namespace Maya.Raynet.Crm.Request.Get
{
    public class Companies : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Company>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Company>>(apiClient);
        }
