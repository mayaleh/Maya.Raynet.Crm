...
namespace Maya.Raynet.Crm.Request.Get
{
    public class LegalTitleTemplates : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.LegalTitleTemplate>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.LegalTitleTemplate>>(apiClient);
        }
