...
namespace Maya.Raynet.Crm.Request.Get
{
    public class BusinessCasesParticipants : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.BusinessCasesParticipants>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.BusinessCasesParticipants>>(apiClient);
        }
