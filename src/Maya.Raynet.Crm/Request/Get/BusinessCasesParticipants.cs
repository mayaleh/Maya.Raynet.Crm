...
namespace Maya.Raynet.Crm.Request.Get
{
    public class BusinessCasesParticipants : GetRequest
    {
        ...
        public async Task<Model.DataResult<Response.BusinessCasesParticipants>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Response.BusinessCasesParticipants>(apiClient);
