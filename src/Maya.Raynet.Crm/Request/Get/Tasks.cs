...
namespace Maya.Raynet.Crm.Request.Get
{
    public class Tasks : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Task>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Task>>(apiClient);
        }
