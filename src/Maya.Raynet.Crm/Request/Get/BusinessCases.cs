...
namespace Maya.Raynet.Crm.Request.Get
{
    public class BusinessCases : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.BusinessCase>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.BusinessCase>>(apiClient);
        }
