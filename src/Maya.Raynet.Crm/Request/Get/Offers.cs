...
namespace Maya.Raynet.Crm.Request.Get
{
    public class Offers : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Offer>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Offer>>(apiClient);
        }
