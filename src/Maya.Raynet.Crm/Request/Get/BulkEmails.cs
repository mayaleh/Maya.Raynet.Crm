...
namespace Maya.Raynet.Crm.Request.Get
{
    public class BulkEmails : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.BulkEmail>>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<List<Response.BulkEmail>>(apiClient);
