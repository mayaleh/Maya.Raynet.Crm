...
namespace Maya.Raynet.Crm.Request.Get
{
    public class BulkEmailRecipients : GetRequest
    {
        ...
        public async Task<Model.DataResult<Response.BulkEmailRecipients>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Response.BulkEmailRecipients>(apiClient);
