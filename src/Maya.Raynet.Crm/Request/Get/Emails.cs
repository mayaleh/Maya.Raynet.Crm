...
{
    public class Emails : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Email>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Email>>(apiClient);
        }
