...
namespace Maya.Raynet.Crm.Request.Get
{
    public class Leads : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Lead>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Lead>>(apiClient);
        }
