...
namespace Maya.Raynet.Crm.Request.Get
{
    public class CompanyCategories : GetRequest
    {
        ...
        public async Task<Model.DataResult<Response.CompanyCategories>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Response.CompanyCategories>(apiClient);
