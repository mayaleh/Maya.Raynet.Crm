...
namespace Maya.Raynet.Crm.Request.Get
{
    public class ProductCategories : GetRequest
    {
        ...
        public async Task<Model.DataResult<Response.ProductCategories>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Response.ProductCategories>(apiClient);
