...
namespace Maya.Raynet.Crm.Request.Get
{
    public class ActivityCategories : GetRequest
    {
        ...
        public async Task<Model.DataResult<Response.ActivityCategories>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Response.ActivityCategories>(apiClient);
