...
{
    public class Letters : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Letter>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Letter>>(apiClient);
        }
