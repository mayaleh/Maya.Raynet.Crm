...
namespace Maya.Raynet.Crm.Request.Get
{
    public class PriceLists : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.PriceList>>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<List<Response.PriceList>>(apiClient);
