...
namespace Maya.Raynet.Crm.Request.Get
{
    public class ProjectParticipants : GetRequest
    {
        ...
        public async Task<Model.DataResult<Response.ProjectParticipants>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Response.ProjectParticipants>(apiClient);
