...
{
    public class Meetings : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Meeting>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Meeting>>(apiClient);
        }
