...
{
    public class Events : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.Event>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.Event>>(apiClient);
        }
