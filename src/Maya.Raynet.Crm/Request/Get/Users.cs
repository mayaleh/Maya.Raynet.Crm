...
namespace Maya.Raynet.Crm.Request.Get
{
    public class Users : GetRequest
    {
        ...
        public new async Task<Model.DataResult<List<Response.Get.User>>> ExecuteAsync(ApiClient apiClient)
        {
            return await base.ExecuteAsync<List<Response.Get.User>>(apiClient);
        }
