...
namespace Maya.Raynet.Crm.Request.Post
{
    public class ProjectCategory : PostRequest
    {
        ...
        public async Task<Model.DataResult<Response.Post.ProjectCategory>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Model.Request.Post.ProjectCategory, Response.Post.ProjectCategory>(apiClient, this.requestBody);
