...
namespace Maya.Raynet.Crm.Request.Post
{
    public class MaritalStatus : PostRequest
    {
        ...
        public async Task<Model.DataResult<Response.Post.MaritalStatus>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Model.Request.Post.MaritalStatus, Response.Post.MaritalStatus>(apiClient, this.requestBody);
