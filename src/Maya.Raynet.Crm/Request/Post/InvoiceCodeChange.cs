...
namespace Maya.Raynet.Crm.Request.Post
{
    public class InvoiceCodeChange : PostRequest
    {
        ...
        public async Task<Model.DataResult<Response.Post.InvoiceCodeChange>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Model.Request.Post.InvoiceCodeChange, Response.Post.InvoiceCodeChange>(apiClient, this.requestBody);
