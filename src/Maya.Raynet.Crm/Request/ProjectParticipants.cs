...
namespace Maya.Raynet.Crm.Request.Get
{
    public class ProjectParticipants : GetRequest
    {
        ...
        public async Task<Model.DataResult<List<Response.ProjectParticipants>>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<List<Response.ProjectParticipants>>(apiClient);
