...
namespace Maya.Raynet.Crm.Request.Put
{
    public class Classification2Person : PutRequest
    {
        ...
        public async Task<Model.DataResult<Response.Put.Classification2Person>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Model.Request.Put.Classification2Person, Response.Put.Classification2Person>(apiClient, this.requestBody);
