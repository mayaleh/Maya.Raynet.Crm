...
namespace Maya.Raynet.Crm.Request.Put
{
    public class FieldOfActivity : PutRequest
    {
        ...
        public async Task<Model.DataResult<Response.Put.FieldOfActivity>> ExecuteAsync(ApiClient apiClient)
                => await base.ExecuteAsync<Model.Request.Put.FieldOfActivity, Response.Put.FieldOfActivity>(apiClient, this.requestBody);
